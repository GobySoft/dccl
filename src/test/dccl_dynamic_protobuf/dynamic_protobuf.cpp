...
int main(int argc, char* argv[])
{
    ...
    {
        // testing compiled in
        auto adyn_msg = dccl::DynamicProtobufManager::new_protobuf_message<
            std::shared_ptr<google::protobuf::Message> >("A");

        std::cout << adyn_msg->GetDescriptor()->DebugString() << std::endl;

        // testing dlopen'd
        auto bdyn_msg = dccl::DynamicProtobufManager::new_protobuf_message<
        ...
        try
        {
            auto cdyn_msg = dccl::DynamicProtobufManager::new_protobuf_message<
        ...
        auto ddyn_msg = dccl::DynamicProtobufManager::new_protobuf_message<
        ...
        auto edyn_msg = dccl::DynamicProtobufManager::new_protobuf_message<
