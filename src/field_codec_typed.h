...
class TypedFieldCodec : public FieldCodecSelector<WireType, FieldType>
{
  ...
  private:
    ...
    void any_pre_encode(boost::any* wire_value, const boost::any& field_value)
    {
        try
        {
    ...
    void any_post_decode(const boost::any& wire_value, boost::any* field_value)
    {
    ...
    any_decode_specific(Bitset* bits, boost::any* wire_value, compiler::dummy<0> dummy = 0)
    {
        try
        {
            google::protobuf::Message* msg =
                boost::any_cast<google::protobuf::Message*>(*wire_value);
...
class RepeatedTypedFieldCodec : public TypedFieldCodec<WireType, FieldType>
{
  ...
  private:
                                 ...
                                 compiler::dummy<0> dummy = 0)
    {
        ...
        {
            google::protobuf::Message* msg =
                boost::any_cast<google::protobuf::Message*>(wire_values->at(i));
