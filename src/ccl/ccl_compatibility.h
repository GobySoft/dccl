...
class IdentifierCodec : public DefaultIdentifierCodec
{
  private:
    ...
    dccl::Bitset encode(const dccl::uint32& wire_value)
    {
        ...
        {
            // DCCL message
            return dccl::DefaultIdentifierCodec::encode(wire_value)
                .prepend(dccl::Bitset(dccl::BITS_IN_BYTE, DCCL_CCL_HEADER));
        }
    }
    ...
    unsigned size(const dccl::uint32& field_value)
    {
        ...
        {
            return dccl::BITS_IN_BYTE + dccl::DefaultIdentifierCodec::size(field_value);
        }
    }
...
class TimeDateCodec : public dccl::TypedFixedFieldCodec<dccl::uint64>
{
  ...
  private:
    ...
    enum
    {
        TIME_DATE_COMPRESSED_BYTE_SIZE = 3
    };
};
  ...
  private:
    ...
    void validate()
    {
        FieldCodecBase::require(
            ...
            "missing (dccl.field).ccl.bit_size");
    }
};
  ...
  private:
    ...
    void validate()
    {
        FieldCodecBase::require(
            ...
            "missing (dccl.field).ccl.thrust_mode_tag");
    }
};
